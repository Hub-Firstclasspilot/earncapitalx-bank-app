            ...
            <div class="container" style="border: 0px solid red;">
				<div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-0 row " style="border: 0px solid blue;">
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 mb10">
                        ...
                        @endif
						<form class="form--dark" method="post" action="{{ route('admin.login.post') }}" style="padding: 25px;margin-right: 15px;">
                            @csrf
							<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
								<h2 class="heading-title">Admin Login</h2>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn--small btn--yellow full-width" style="margin-bottom: 10px;">
								Login
							</button>
                            </div>
						</form>
