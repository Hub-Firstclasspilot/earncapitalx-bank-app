...
]" data-locations="London

Address: 11 Church Road, Great Bookham, Surrey, England, KT23 3PB" data-zoom="16" data-map-type="roadmap" data-custom-marker="{{ asset('assets/front/img/marker-google.png') }}">
						<div class="block-location-info">
							...
							<h6 class="adress">London

Address: 11 Church Road, Great Bookham, Surrey, England, KT23 3PB</h6>
						</div>
				...
				<div class="col-lg-3 col-lg-offset-1 col-md-4 col-sm-12 col-xs-12 d-flex-align-middle mt30" data-mh="equal-block">
					...
					<div>
						<header class="crumina-module crumina-heading heading--h3 heading--with-decoration">
							...
							<div class="heading-text">Safehavenfx</div>
						</header>
						...
						<div class="info-wrap">
							...
							<div class="info">Email: <a href="mailto:info@safehavenx.com">info@safehavenx.com</a></div>
						</div>
			...
			<div class="row pb120">
				<div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
						...
						<div class="heading-text">We are available 24/7 to respond to all tickets .</div>
					</header>
				</div>
