			...
			<div class="row medium-padding120 align-center">
				<div class="col-lg-8 col-lg-offset-2 col-md-12 col-sm-12 col-xs-12">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
						...
						<h2 class="heading-title heading--half-colored">Cryptocurrencies</h2>
						<div class="heading-text">Currency trading, also known as FX trading, is the exchange of currencies between two parties at an agreed price.</div>
					</header>
					<a data-scroll href="{{ route('register') }}" class="btn btn--orange btn--medium">Get Started Now!</a>
				</div>
			</div>
		</div>
	</section>
					...
					<div id="coin" class="tabs tabs--style-scaled">
						...
						<ul role="tablist">
							<li role="presentation" class="tab-control active">
								<a href="#tab-19" role="tab" data-toggle="tab" class="control-item">
									<div class="tab-thumb">
							...
							<li role="presentation" class="tab-control">
								<a href="#tab-20" role="tab" data-toggle="tab" class="control-item">
									<div class="tab-thumb">
							...
							<li role="presentation" class="tab-control">
								<a href="#tab-21" role="tab" data-toggle="tab" class="control-item">
									<div class="tab-thumb">
							...
							<li role="presentation" class="tab-control">
								<a href="#tab-22" role="tab" data-toggle="tab" class="control-item">
									<div class="tab-thumb">
									...
									<h6 class="tab-title">Litecoin <span>LTC</span></h6>
								</a>
							</li>
							<li role="presentation" class="tab-control">
								<a href="#tab-23" role="tab" data-toggle="tab" class="control-item">
									<div class="tab-thumb">
									...
									<h6 class="tab-title">Ripple <span>XRP</span></h6>
								</a>
							</li>
						</ul>
				...
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb30">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration">
						<h2 class="heading-title heading--half-colored">Use our cryptocoins
							<span class="weight-bold">converter</span></h2>
						<div class="heading-text">
                            Currency trading is done in pairs. A currency pair consists of a base and a quote currency – for example, the currency pair of EUR/USD consists of EUR, which represents the base currency, and USD which represents the quote currency.
                        </div>
					</header>
					<a href="005_coin_market.php" class="primary-link-with-icon">Go to Coin Market
						<svg class="woox-icon icon-arrow-right">
							<use xlink:href="{{ asset('assets/front/svg-icons/sprites/icons.svg#icon-arrow-right') }}"></use>
						</svg>
					</a>
				</div>
				...
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb30">
					...
					<ul class="crumina-module crumina-circled-block">
						<li class="circle__item">
							<img src="{{ asset('assets/front/img/paypal.png') }}" class="woox-icon" alt="paypal">
							<div class="title">PayPal</div>
						</li>
						<li class="circle__item">
							<img src="{{ asset('assets/front/img/mastercard.png') }}" class="woox-icon" alt="mastercard">
							<div class="title">Mastercard</div>
						</li>
						<li class="circle__item">
							<img src="{{ asset('assets/front/img/visa.png') }}" class="woox-icon" alt="visa">
							<div class="title">Visa</div>
						</li>
						<li class="circle__item">
							<img src="{{ asset('assets/front/img/if_Bitcoin_2745023.png') }}" class="woox-icon" alt="paypal">
				...
				<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
					<header class="crumina-module crumina-heading heading--h2 heading--with-decoration pb60">
						<h2 class="heading-title heading--half-colored">Investment
							<span class="weight-bold">details</span></h2>
					</header>
						...
						<li class="accordion-panel">
							<div class="panel-heading">
								<a href="#toggleSample4" class="accordion-heading collapsed" data-toggle="collapse" data-parent="#accordion" aria-expanded="false">
									<span class="icons">
										<svg class="woox-icon icon-plus-sign"><use xlink:href="{{ asset('assets/front/svg-icons/sprites/icons.svg#icon-plus-sign') }}"></use></svg>
										<svg class="woox-icon active icon-min"><use xlink:href="{{ asset('assets/front/svg-icons/sprites/icons.svg#icon-min') }}"></use></svg>
									</span>
									<span class="title">What is trading ?</span>
								</a>
							</div>

							<div id="toggleSample4" class="panel-collapse collapse" aria-expanded="false" role="tree">
								<div class="panel-info">
                                    Trading Forex generally is a foreign exchange market where one currency is traded for another. It is one of the largest markets in the world.
								</div>
							</div>
						</li>
						...
						<li class="accordion-panel">
							<div class="panel-heading">
								<a href="#toggleOne4" class="accordion-heading collapsed" data-toggle="collapse" data-parent="#accordion" aria-expanded="false">
									...
									<span class="title">How much can i make ?</span>
								</a>
							</div>

							<div id="toggleOne4" class="panel-collapse collapse" aria-expanded="false" role="tree">
								<div class="panel-info">
								Your success depends on your skills and patience, your chosen trading strategy, and the amount you are able to invest. We recommend you contact our Support Team first, so you can make more informed transactions. Beginning traders can try out their skills and practice on the practice account provided by the account manager.								</div>
							</div>
						</li>
						...
						<li class="accordion-panel">
							<div class="panel-heading">
								<a href="#toggleTwo4" class="accordion-heading collapsed" data-toggle="collapse" data-parent="#accordion" aria-expanded="false">
									...
									<span class="title">Can I lose more than I invest in Forex?</span>
								</a>
							</div>
